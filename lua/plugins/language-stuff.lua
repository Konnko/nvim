  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        emmet_ls = {},
        tailwindcss = {
          filetypes = { 'html', 'css', 'scss', 'javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'svelte', 'vue', 'elixir', 'eelixir', 'heex' },
          init_options = {
            userLanguages = {
              elixir = 'html',
              eelixir = 'html',
      ...
      --  Mason package names (not lspconfig names) are used here.
